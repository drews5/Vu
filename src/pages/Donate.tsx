    ...
    return (
        <PageTransition className="pb-8 md:pb-16 min-h-screen">
            ...
            <motion.section variants={childVariants} style={{ marginTop: '25px', marginBottom: '25px' }}>
                <div className="vu-page-hero bg-[#91a8c6] py-8 md:py-12 px-4 text-center text-white border border-gray-100" style={{ borderRadius: '16px' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <motion.div variants={childVariants} className="order-1 lg:order-2 lg:col-span-5 space-y-6">
                    {/* Venmo */}
                    <div className="vu-panel bg-white p-0 border border-gray-100 overflow-hidden" style={{ borderRadius: '16px' }}>
                        <div className="flex items-center gap-3 border-b border-gray-100 bg-[#008CFF] px-6 py-4 text-white">
                            ...
                            <h2 className="text-xl font-semibold" style={fontInter}>Donate with Venmo</h2>
                        </div>
                        <div className="p-6 md:p-8">
                            <div className="mb-6 flex items-center gap-4">
                                <div className="flex size-16 shrink-0 items-center justify-center rounded-full bg-[#8FA8C8]">
                                    <img src={logoImage} alt="" className="w-11 h-auto" />
                                </div>
                                <div>
                                    <p className="font-semibold text-[#2B4C6F]" style={fontInter}>Vocal U A Cappella</p>
                                    <p className="text-[#008CFF]" style={fontInter}>@vocalu</p>
                                </div>
                            </div>
                ...
                <motion.div variants={childVariants} className="order-2 lg:order-1 lg:col-span-7 lg:row-span-2 bg-white overflow-hidden relative flex flex-col border border-gray-100" style={{ borderRadius: '16px', minHeight: '800px', width: '100%' }}>
                ...
                <motion.div variants={childVariants} className="order-3 lg:order-2 lg:col-span-5 space-y-6">
                    <div className="bg-white p-8 border border-gray-100" style={{ borderRadius: '16px' }}>
